/*
    [ 웹스토리지 ]
        ...
        2. 사용법
            sessionStorage 객체
            localStorage 객체
            (1) sessionStorage.setItem( '속석명/key' , '값/value');            
    ...
    [ JSON ] : 자바스크립트 객체 문법의 형식 , JavaScript Object notaion
        * 자바객체를 문자열타입 이지만 객체형식/모양 으로 표현한것
        ...
        - 왜??? 인터넷상의 데이터를 통신하는 http 는 객체지향이 아니다. 문자열과 바이트 전송만 가능
...
// [5] 웹스토리지에 JSON 객체 저장
// sessionStorage.setItem( 'm1' , ['유재석', 40]);                   // [x] 대괄호 포함하지않음
