...
*/
/*
let high = prompt("삼각형높이:");
let bottom = prompt("삼각형밑변:");
let result = Number(bottom) * Number(high) / 2;
console.log(result);
*/
/*
문제 2: 섭씨를 화씨로 변환
...
*/
/*
let year = prompt("태어난년도:");
let old = 2025 - Number(year);
console.log(old);
*/ 
/*
문제 4: BMI 지수 계산
...
*/
/*
let told = Number(prompt("키:"));
let big = Number(prompt("몸무게:"));
let cm = told / 100;
let bmi = big / (parseFloat(cm) * parseFloat(cm));
console.log(bmi);
*/
/*
문제 5: 관리자 확인
...
let result = id == 'admin' || emaill == 'admin@test.com' ? '관리자' : '일반 사용자';
console.log(result);
*/
/*
문제 6: 학점 변환기 (HTML 출력)
...
/*
let 점수 = prompt("점수:");
let 결과 = 점수 >= 90 ? 'A' : 90 > 점수 && 점수 >=80 ? 'B' : 70 > 점수 ? 'C' : "불합격";
...
/*
let age = prompt("나이:");
let event = 29 >= age && age >= 20 ? "이벤트 대상입니다." : "이벤트 대상이 아닙니다.";
console.log(event);
*/
/*
문제 8: '좋아요' 카운터 만들기
...
let likeCount = 3;
++likeCount;
console.log(`"좋아요: ${[Number(likeCount)]}"`);
*/
/*
...
let plus = prompt("새할일");                     // 입력받기 , 입력받고 입력받은 값으로 다음행동이 필요하므로  저장
todoList.push = plus;
...
waitingList.splice( 0 , 3);
console.log(`"마지막 대기자는 [${waitingList}]입니다."`)
*/