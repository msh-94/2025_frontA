...
/*
    [변수]
        ...
        2. 목적 : 재사용성 , 가독성
        3. 사용법
            (변수를 선언하는 방법) : 초기값이 없다. *초기값이란? 변수 선언(만들)할때 초기에 대입되는 값
                let 변수명
    ...
    [상수]
        ...
        4. 형태                                     
            ...
            2. 변수명   : 메모리 공간의 상징적인 이름       * wjscpeoanswk : pi -> PI
            3. =        : 
...
console.log(이름1)      // undefiend ( 변수는 선언되었지만 값이 할당 되지 않은 상태 )
console.log(이름2)      // 유재석 , 이름2 라는 변수가 가지는 변수값을 출력

// 3. 변수의 값을 수정하는 방법 , 변수명 = 새로운값
이름1 = "강호동"        // 이름1라는 변수를 호출하여 새로운값 대입
이름2 = "유재석2"       // 이름2라는 변수를 호출하여 새로운값 대입
console.log(이름1)      // 강호동
