...
// 1. { 속성명 : 자료 , 속성명 : 자료 , 속성명 : 자료}
    // { name : "민성호" , age : 32 , city : "인천" };
// 2. let/const 변수명 = { }
// const person = { name : "민성호" , age : 32 , city : "인천" };
// 3. 출력
// console.log( person ); // { name : "민성호" , age : 32 , city : "인천" };
...
// person.email = 'qweqwe@naver.com';  // 추가
// delete person.age;                  // 삭제
// console.log( person );              // {name: '김코딩', email: 'qweqwe@naver.com'}
